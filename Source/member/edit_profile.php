...
<body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-white white-sidebar-color logo-red">
								...
								<div class="card-body row">
									<div class="col-lg-6 p-t-20">
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input name="name" class="mdl-textfield__input" type="text" id="txtFirstName" value="<?php echo $_SESSION['userdata']['name']; ?>" required>
									...
									<div class="col-lg-6 p-t-20">
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input name="designation" class="mdl-textfield__input" type="text" id="designation" value="<?php echo $_SESSION['userdata']['designation']; ?>" required>
									...
									<div class="col-lg-6 p-t-20">
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input name="email" class="mdl-textfield__input" type="email" id="txtemail" value="<?php echo $_SESSION['userdata']['email']; ?>" required>
									...
									<div class="col-lg-6 p-t-20">
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input name="username" class="mdl-textfield__input" type="text" id="username" value="<?php echo $_SESSION['userdata']['username']; ?>" required>
									...
									<div class="col-lg-6 p-t-20">
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input name="joining_date" class="mdl-textfield__input" type="text" value="<?php echo $_SESSION['userdata']['joining_date']; ?>" id="date" readonly>
									...
									<div class="col-lg-12 p-t-20 text-center">
										...
										<button onclick="location.href='index.php'" type="button" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-circle btn-danger">Cancel</button>
									</div>
								</div>
							</div>
						</div>
	...
	<?php if (isset($_POST['form_submitted'])) : ?>
		...
		$result = "UPDATE `members` SET `name`='$name',`designation`='$designation',`joining_date`='$joining_date',`email`='$email',`username`='$username',`password`='$password',`dept_id`='$dept_id',`dept`='$dept' WHERE id = $member_id";
		if ($conn->query($result) === TRUE) {
			echo '<script>alert("Profile Edited Successfully")</script>';
			echo '<script>alert("Now you will be Logged out and You have to login again.")</script>';
			redirect('classes/Login.php?f=pmanagerlogout');
		} else {
