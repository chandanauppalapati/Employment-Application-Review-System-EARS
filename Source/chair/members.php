				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">All Committee Members</div>
							</div>
										...
										<div class="row">
											<div class="col-md-12">
												<div class="card card-box">
													<div class="card-head">
														<header>All Committee Members</header>
														<div class="tools">
													...
													<div class="card-body ">
														<div class="row">
															<div class="col-md-6 col-sm-6 col-6">
																<div class="btn-group">
																	<a href="add_member.php" id="addRow"
															...
															<tbody>
																...
																while ($row = $result->fetch_array(MYSQLI_ASSOC)) {
																	...
																	echo ' <tr class="odd gradeX">
																				...
																				'.$row["email"].' </a></td>
																				<td>
																					<a href="edit_profile_member.php?member_id='.$row["id"].'"
																						class="tblEditBtn">
