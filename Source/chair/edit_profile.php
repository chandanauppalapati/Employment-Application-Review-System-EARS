...
<body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-white white-sidebar-color logo-red">
						...
						<div class="col-sm-12">
							<div class="card-box">
								...
								<div class="card-body row">
									...
									<div class="col-lg-6 p-t-20">
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input name="designation" class="mdl-textfield__input" type="text" id="designation" value="Chairperson" required>
	...
	<?php if (isset($_POST['form_submitted'])) : ?>
		...
		$result = "UPDATE `chair` SET `name`='$name',`email`='$email',`username`='$username',`password`='$password',`dept_id`='$dept_id',`dept`='$dept' WHERE id = $chair_id";
