					...
					<div id="remove-scroll" class="left-sidemenu">
						<ul class="sidemenu  page-header-fixed slimscroll-style" data-keep-expanded="false"
							...
							<li class="sidebar-user-panel">
								<div class="sidebar-user">
									...
									<div class="sidebar-user-details">
										...
										<div class="user-role">Chairperson</div>
							...
							<li class="nav-item">
								...
								<ul class="sub-menu">
									<li class="nav-item">
										<a href="all_jobs.php" class="nav-link "> <span class="title">All Job Postings</span>
											<span class="selected"></span>
										</a>
									</li>
									<li class="nav-item">
										<a href="add_job.php" class="nav-link "> <span class="title">Add Job Posting</span>
										</a>
									</li>
								</ul>
							</li>							
							<li class="nav-item">
								...
								<ul class="sub-menu">
									<li class="nav-item">
										<a href="members.php" class="nav-link "> <span class="title">All
												Committee Members</span>
										</a>
									</li>
									<li class="nav-item">
										<a href="add_member.php" class="nav-link "> <span class="title">Add
