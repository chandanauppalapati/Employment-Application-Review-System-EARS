            ...
            <div class="page-content">
                <div class="page-bar">
                    <div class="page-title-breadcrumb">
                        <div class=" pull-left">
                            <div class="page-title">Applications Reviews</div>
                        </div>
                        <ol class="breadcrumb page-breadcrumb pull-right">
                            ...
                            <li class="active">Applications Reviews</li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="card card-box">
                                                <div class="card-head">
                                                    <header>Applications Review for Application ID :-
                                                        application-<?php echo $application_id ?></header>
                                                    <div class="tools">
                                                ...
                                                <div class="card-body ">
                                                    ...
                                                    <table
                                                        ...
                                                        <tbody>
															...
															$result = $conn->query("SELECT * FROM `application_review` WHERE `application_id` = $application_id");
															$rowCount = 0;
															while ($row = $result->fetch_array(MYSQLI_ASSOC)) {
																// echo $row["name"];
																$rowCount = $rowCount + 1;
																$vote = ($row["up_vote"])? "Up Vote":"Down Vote";
