						...
						<div class="card-box">
							...
							<div class="card-body ">
								...
								<div class="row">
                                    ...
                                    $result = $conn->query("SELECT * FROM `jobs` WHERE `dept_id` = $dept_id AND `close` != 1");
                                        ...
                                        echo ' <div class="col-lg-6 col-md-6 col-12 col-sm-6 ">
                                                    <div style="padding:20px; border:2px black solid; border-radius:25px; box-shadow:10px 5px 10px #bbbbbb;" class="blogThumb">
                                                        ...
                                                        <div style="margin: auto; width:fit-content;" >
                                                            <a style="margin-right:20px;" href="all_applications.php?job_id='.$row["id"].'" type="button"
                                                                class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-info">See Applications</a>
                                                            <a href="job_access.php?job_id='.$row["id"].'" type="button"
                                                                class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-info">Give Access to Committee Members</a>
                                                        </div>
                                                    </div>
                                                </div>';
                                    }
